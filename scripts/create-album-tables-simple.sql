...
CREATE POLICY "Users can manage their album images" ON album_images
  FOR ALL USING (
    EXISTS (
...
CREATE POLICY "Users can manage their album orders" ON album_orders
  FOR ALL USING (auth.uid() = user_id);
